...
import { DaydreamCore } from "../core.js";
...
import { DaydreamError } from "../models/errors/daydreamerror.js";
import {
  ConnectionError,
  InvalidRequestError,
  RequestAbortedError,
 ...
 */
export function streamsGetById(
  client: DaydreamCore,
...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(operations.GetStreamByIdRequest$outboundSchema, value),
