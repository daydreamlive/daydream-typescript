...
async function run() {
  const result = await daydream.streams.getAll();
...
async function run() {
  const result = await daydream.streams.delete({
    id: "<id>",
  });
...
async function run() {
  const result = await daydream.streams.update({
    id: "<id>",
    body: {
      pipeline: "streamdiffusion",
      params: {
...
async function run() {
  const result = await daydream.streams.getById({
    id: "<id>",
  });
