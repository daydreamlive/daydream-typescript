# SDTurbo2ImagePostprocessingType

## Example Usage

```typescript
import { SDTurbo2ImagePostprocessingType } from "@daydreamlive/sdk/models";

let value: SDTurbo2ImagePostprocessingType = "temporal_net_tensorrt";
```
