# Sd152ImagePostprocessingType

## Example Usage

```typescript
import { Sd152ImagePostprocessingType } from "@daydreamlive/sdk/models";

let value: Sd152ImagePostprocessingType = "temporal_net_tensorrt";
```
